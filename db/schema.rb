...
ActiveRecord::Schema.define(version: 20160715024139) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"
  enable_extension "uuid-ossp"

  create_table "access_types", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string   "accessType"
  ...
  create_table "attending_lists", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.uuid     "userID"
    t.uuid     "eventID"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "event_urls", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string   "url"
    t.uuid     "eventID"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
